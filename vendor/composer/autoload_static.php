...
class ComposerStaticInitf3566b468469bd769f4f9d6fe75a5367
{
    ...
    public static $classMap = array (
        ...
        'Affilicious\\Attribute\\Setup\\Admin_Table_Setup' => __DIR__ . '/../..' . '/src/attribute/setup/admin-table-setup.php',
        ...
        'Affilicious\\Common\\Filter\\Admin_Footer_Text_Filter' => __DIR__ . '/../..' . '/src/common/filter/admin-footer-text-filter.php',
        ...
        'Affilicious\\Common\\Setup\\Asset_Setup' => __DIR__ . '/../..' . '/src/common/setup/asset-setup.php',
        'Affilicious\\Common\\Setup\\Carbon_Setup' => __DIR__ . '/../..' . '/src/common/setup/carbon-setup.php',
        'Affilicious\\Common\\Setup\\Feedback_Setup' => __DIR__ . '/../..' . '/src/common/setup/feedback-setup.php',
        'Affilicious\\Common\\Setup\\License_Handler_Setup' => __DIR__ . '/../..' . '/src/common/setup/license-handler-setup.php',
        ...
        'Affilicious\\Product\\Filter\\Table_Content_Filter' => __DIR__ . '/../..' . '/src/product/filter/table-content-filter.php',
        'Affilicious\\Product\\Filter\\Table_Count_Filter' => __DIR__ . '/../..' . '/src/product/filter/table-count-filter.php',
        ...
        'Affilicious\\Product\\Setup\\Update_Mediator_Setup' => __DIR__ . '/../..' . '/src/product/setup/update-mediator-setup.php',
        ...
        'Affilicious\\Product\\Update\\Configuration\\Configuration_Context_Interface' => __DIR__ . '/../..' . '/src/product/update/configuration/configuration-context-interface.php',
        'Affilicious\\Product\\Update\\Configuration\\Configuration_Interface' => __DIR__ . '/../..' . '/src/product/update/configuration/configuration-interface.php',
        ...
        'Affilicious\\Product\\Update\\Configuration\\Configuration_Resolver_Interface' => __DIR__ . '/../..' . '/src/product/update/configuration/configuration-resolver-interface.php',
        'Affilicious\\Product\\Update\\Manager\\Update_Manager' => __DIR__ . '/../..' . '/src/product/update/manager/update-manager.php',
        'Affilicious\\Product\\Update\\Manager\\Update_Manager_Interface' => __DIR__ . '/../..' . '/src/product/update/manager/update-manager-interface.php',
        'Affilicious\\Product\\Update\\Queue\\Update_Mediator' => __DIR__ . '/../..' . '/src/product/update/queue/update-mediator.php',
        'Affilicious\\Product\\Update\\Queue\\Update_Mediator_Interface' => __DIR__ . '/../..' . '/src/product/update/queue/update-mediator-interface.php',
        ...
        'Affilicious\\Product\\Update\\Task\\Batch_Update_Task_Interface' => __DIR__ . '/../..' . '/src/product/update/task/batch-update-task-interface.php',
        'Affilicious\\Product\\Update\\Task\\Update_Task' => __DIR__ . '/../..' . '/src/product/update/task/update-task.php',
        'Affilicious\\Product\\Update\\Task\\Update_Task_Interface' => __DIR__ . '/../..' . '/src/product/update/task/update-task-interface.php',
        ...
        'Affilicious\\Provider\\Validator\\Amazon_Credentials_Validator' => __DIR__ . '/../..' . '/src/provider/validator/amazon-credentials-validator.php',
        'Affilicious\\Provider\\Validator\\Amazon_Credentials_Validator_Interface' => __DIR__ . '/../..' . '/src/provider/validator/amazon-credentials-validator-interface.php',
        ...
        'Affilicious\\Shop\\Setup\\Admin_Table_Setup' => __DIR__ . '/../..' . '/src/shop/setup/admin-table-setup.php',
