    ...
    <div class="aff-import-config-group aff-panel">
        ...
        <div class="aff-import-config-group-body aff-panel-body">
            <label class="aff-import-config-group-label" for="publish">
                <input class="aff-import-config-group-option aff-amazon-import-config-group-option-publish" name="status" type="radio" value="publish" checked>
		        <?php _e('Publish product directly', 'affilicious'); ?>
            </label>

            <label class="aff-import-config-group-label" for="draft">
                <input class="aff-import-config-group-option aff-amazon-import-config-group-option-draft" name="status" type="radio" value="draft">
