...
<?php do_action('affilicious_template_before_product_universal_box_thumbnail', $product); ?>

<?php if(has_post_thumbnail()): ?>
    <?php the_post_thumbnail('aff-product-thumbnail', [
...
<?php do_action('affilicious_template_after_product_universal_box_thumbnail', $product); ?>
