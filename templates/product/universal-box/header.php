...
<?php do_action('affilicious_template_before_product_universal_box_header', $product); ?>
...
<?php do_action('affilicious_template_after_product_universal_box_header', $product); ?>
